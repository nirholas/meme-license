...
Attach concise remix permissions and provenance to viral onchain media.

## Why this exists

Solana transaction v1 raises the maximum transaction size from 1,232 to 4,096 bytes. Meme License explores a focused consumer use of that space while making the wire budget visible.
